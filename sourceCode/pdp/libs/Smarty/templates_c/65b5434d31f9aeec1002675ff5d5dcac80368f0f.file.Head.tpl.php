<?php /* Smarty version Smarty-3.0.7, created on 2011-03-23 14:28:19
         compiled from "./templates/modules/ManageLabPreferences/Head.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21383081464d89e76390f2f8-00441841%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65b5434d31f9aeec1002675ff5d5dcac80368f0f' => 
    array (
      0 => './templates/modules/ManageLabPreferences/Head.tpl',
      1 => 1300883289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21383081464d89e76390f2f8-00441841',
  'function' => 
  array (
  ),
...
<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['name'] = 'curLesson';
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('availableLessons')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['loop']-1;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['show']) {
    $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['total'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['loop'];
    if ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['total'] == 0)
        $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['show'] = false;
} else
    $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['total'] = 0;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['show']):

            for ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['start'], $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration'] = 1;
                 $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration'] <= $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['total'];
                 $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index'] += $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['step'], $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration']++):
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['rownum'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index_prev'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index'] - $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['step'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index_next'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['index'] + $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['step'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['first']      = ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration'] == 1);
$_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['curLesson']['total']);
?>
    availableIDS[<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['curLesson']['index'];?>
] = "<?php echo $_smarty_tpl->getVariable('availableLessons')->value[$_smarty_tpl->getVariable('smarty')->value['section']['curLesson']['index']];?>
"
<?php endfor; endif; ?>
